import type { InterventionId, LocationId, ReasonId, SourceId } from './scenario.ts'

export type ScreenNumber = 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8
export type Confidence = 1 | 2 | 3 | 4 | 5
export type RevisionCount = 0 | 1
export type ScreenName = 'intro' | 'town-map' | 'research' | 'planning' | 'decision' | 'outcome' | 'reflection' | 'session-summary'
